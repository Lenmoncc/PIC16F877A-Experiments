	...
	; Compiler options:
	;
	; -oPIC16F877A_CAR.cof -mPIC16F877A_CAR.map --summary=default \
	; --output=default beep.p1 JY62.p1 LCD.p1 LED.p1 main.p1 PWM.p1 \
	; delay.p1 motor.p1 node.p1 track.p1 --chip=16F877A -P \
